...
from lfd_proposed_one_layer import LfDProposed
...
class RolloutProposed:
    def __init__(self) -> None:
        ...
        model_weights_path = '/root/Research_Internship_at_GVlab/ablation/real/model/proposed/proposed_model4_one_layer.pth'
